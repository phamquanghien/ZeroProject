...
using ABPNetCore.Models.TokenAuth;
...
{
    public abstract class ABPNetCoreWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ABPNetCoreWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ABPNetCoreWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ABPNetCoreDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ABPNetCoreDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ABPNetCoreDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ABPNetCoreDbContext, Task<T>> func)
        {
            T result;
